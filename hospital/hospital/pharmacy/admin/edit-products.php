...
if(isset($_POST['submit']))
{
	...
	$update="UPDATE  products set category='$category',productName='$productname',productPrice='$productprice',productDescription='$productdescription',shippingCharge='$productscharge',productAvailability='$productavailability',productDiscount='$productpricebd' where id='$pid'";
...
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Enter Product Price" value="<?php echo $row['productPrice'];?>"  class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productprice"  placeholder="Enter Product Price" value="<?php echo htmlentities($row['productDiscount']);?>" class="span8 tip" required>
</div>
</div>

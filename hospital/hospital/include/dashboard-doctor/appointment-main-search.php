                                      ...
                                      <div class="row">
                                          <div class="col-md-12">                                 
                                                ...
                                                <?php 
                                                  $count = 1;
                                                  $date_now = date("Y-m-d");
                                                  $query = "SELECT * FROM appointment_detail WHERE appointment_date = '$date_now' AND (appointment_status = 'applied' OR appointment_status = 'rescheduled') AND homecare_present = '1' AND doctor_email = '".$_SESSION['userID']."';";
                                                  if(isset($_POST['view'])){
                                                      if($_POST['view'] == 'current'){
                                                        $query = "SELECT * FROM appointment_detail WHERE  (appointment_status = 'applied' OR appointment_status = 'rescheduled') AND homecare_present = '1'  AND doctor_email = '".$_SESSION['userID']."' ORDER BY appointment_ID DESC;";  
                                                      }
                                                      else if($_POST['view'] == 'previous'){
                                                          $query = "SELECT * FROM appointment_detail WHERE (appointment_status = 'cancelled' OR appointment_status = 'completed') AND homecare_present = '1'  AND doctor_email = '".$_SESSION['userID']."' ORDER BY appointment_ID DESC;";
                                                      }
                                                      else if($_POST['view'] == 'all'){
                                                         $query = "SELECT * FROM appointment_detail WHERE homecare_present = '1'  AND doctor_email = '".$_SESSION['userID']."' ORDER BY appointment_ID DESC;";
                                                      }
                                                  }
